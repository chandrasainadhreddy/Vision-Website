  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.backendMessage) {
        setFieldErrors({ form: err.backendMessage })
      } else if (err.status === 409) {
        setFieldErrors({ email: 'Email already registered' })
      } else if (err.message) {
        setFieldErrors({ form: `Registration failed: ${err.message}` })
      } else {
        setFieldErrors({ form: 'Network error while registering. Please check your connection and try again.' })
      }
    } finally {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border ${fieldErrors.fullName ? 'border-red-500' : 'border-gray-200'} text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all`}
                />
              </div>
              {fieldErrors.fullName && <div className="text-xs text-red-600 mt-1 ml-1">{fieldErrors.fullName}</div>}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border ${fieldErrors.email ? 'border-red-500' : 'border-gray-200'} text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all`}
                />
              </div>
              {checkingEmail && <div className="text-xs text-gray-500 mt-1 ml-1">Checking email...</div>}
              {fieldErrors.email && (
                <div className="text-xs text-red-600 mt-1 ml-1">{fieldErrors.email}</div>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border ${fieldErrors.phone ? 'border-red-500' : 'border-gray-200'} text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all`}
                />
              </div>
              {fieldErrors.phone && <div className="text-xs text-red-600 mt-1 ml-1">{fieldErrors.phone}</div>}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-3 rounded-xl border ${fieldErrors.password ? 'border-red-500' : 'border-gray-200'} text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all`}
                />
                <button
                  type="button"
              ...
              {fieldErrors.password ? (
                <div className="text-xs text-red-600 mt-1 ml-1">{fieldErrors.password}</div>
              ) : (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-3 rounded-xl border ${fieldErrors.confirmPassword ? 'border-red-500' : 'border-gray-200'} text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all`}
                />
                <button
                  type="button"
              ...
              {fieldErrors.confirmPassword && (
                <div className="text-xs text-red-600 mt-1 ml-1">{fieldErrors.confirmPassword}</div>
              )}
            </div>
