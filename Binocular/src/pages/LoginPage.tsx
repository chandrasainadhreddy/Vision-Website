            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3.5 rounded-xl border ${fieldErrors.email ? 'border-red-500' : 'border-gray-200'} text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all`}
                />
              </div>
              {fieldErrors.email && <div className="text-xs text-red-600 mt-1 ml-1">{fieldErrors.email}</div>}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-11 py-3.5 rounded-xl border ${fieldErrors.password ? 'border-red-500' : 'border-gray-200'} text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all`}
                />
                <button
                  type="button"
              ...
              {fieldErrors.password && <div className="text-xs text-red-600 mt-1 ml-1">{fieldErrors.password}</div>}
            </div>
